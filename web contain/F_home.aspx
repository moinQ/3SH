<%@ Page Language="C#" AutoEventWireup="true" CodeFile="F_home.aspx.cs" Inherits="web_contain_f1" %>
...
<link  rel="stylesheet" type="text/css" href="style/templatemo-style.css"/>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_header_bar">
            ...
            <div id="header"><div class="right"></div>
                ...
                <h1><a href="#" target="_parent">Farmer
                   ...
                   <br />
                     <h3 id ="eid" runat="server"  class="eid" style="color:white;" > </h3> 
                </a></h1>\
      </div>
	...
	<h4><strong>Quantity: </strong>
        <asp:Label ID="qt" runat="server" Text="Label"></asp:Label>&nbsp;<strong> </strong></h4>
	...
	<br/><strong>Availability period: </strong>
        <asp:Label ID="av_period" runat="server" Text="Label"></asp:Label>
         <button runat="server" id="order" onserverclick="order_ServerClick"  style="position:relative"><b> Request</b> </button>
        <br /> 
	</h4>
	...
	<h4><strong>Quantity: </strong>
        <asp:Label ID="L1" runat="server" Text="Label"></asp:Label>K.G&nbsp; 
	...
	<br/><strong>Availability period: </strong>
        <asp:Label ID="L6" runat="server" Text="Label"></asp:Label>
         <button runat="server"  id="Button1" onserverclick="order_ServerClick"  style="position:relative"> <b> Request</b> </button> 
