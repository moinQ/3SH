<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FA_change.aspx.cs" Inherits="web_contain_FA_change" %>
    ...
    <div id="templatemo_header_bar">
            ...
            <div id="header"><div class="right"></div>
                ...
                <h1><a href="#" target="_parent">Field Agent
                    ...
                    <h3 id="EID" runat="server">email</h3>
                </a></h1>
      </div>
    </div>    
    ...
    <div id="templatmeo_content">
        ...
        <h2>Change Password</h2>
                    ...
                    <div class="q required">
						Old Password&nbsp;<input id="oldpass" type="text" size="48" maxlength="255"  name="oldpass" runat="server" required />
					</div>
					<div class="q required">
						New password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="newpass" type="password" size="48" name="newpassword" runat="server" required />
					</div>
                    <div class="q required">
					...
					<input type="submit"  id="submit" name="Search"  runat="server" onserverclick="submit_ServerClick"></form>
                                    <div class="cleaner"></div>
        </div>
     </div>
   </div>
