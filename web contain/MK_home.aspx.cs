...
public partial class web_contain_Mhome : System.Web.UI.Page
{
    ...
    protected void red()
    {
        ...
        cmd = new SqlCommand("select * from ManufactureDetails where Mm_id='" + str1 + "'", con);
    ...
    protected void sb1_ServerClick(object sender, EventArgs e)
    {
        ...
        da = new SqlDataAdapter("select * from product where name like '%" + x + "%'", con);
        ds = new DataSet();
        da.Fill(ds, "aaaa");
        global.i = ds.Tables["aaaa"].Rows.Count - 1;
    ...
    protected void sech()
    {
        ...
        while (rst.Read())
        {
            ...
            l4.Text = Convert.ToString(rst.GetValue(4));
