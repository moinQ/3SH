<%@ Page Language="C#" AutoEventWireup="true" CodeFile="M_addReqment.aspx.cs" Inherits="web_contain_M_addReqment1" %>
...
function myf() {
    document.getElementById("needBy").type = "date";
    ...
    <div id="templatmeo_content">
        ...
        <h2>Requirement</h2>
                    ...
                    <div class="q required">
						Type of Crop&nbsp;<input id="typ" type="text" size="48" maxlength="255" name="tc" runat="server" required/>
					</div>
					<div class="q required">
						Name of Crop&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  id="name" type="text" size="48" maxlength="255" runat="server" name="nc" />
					</div>
                    <div class="q required">
						Crop Details&nbsp; <input  id="cropD" type="text" size="48" maxlength="255" name="cropdetails" runat="server"/>
					</div>
					 <div class="q required">
						Needed For&nbsp; <input id="need" type="text" size="48" maxlength="255" name="neededfor" runat="server"/>
					</div>
					<div class="q required">
						Quantity Needed&nbsp;<input min="0" id="quantity" type="number" size="48" maxlength="255" name="qtyneede" runat="server"/>
					</div>
					<div class="q required">
						Needed By&nbsp;<input  id="needBy" type="text"   size="48" maxlength="255" name="neededby" runat="server"  onfocus="myf()" />
					</div>
					<div class="q required">
						Other Details&nbsp;<input  id="Od" type="textarea" size="48" maxlength="255" name="od" runat="server"></input>
					</div>
					<button type="submit" name="Search"  id="submit" runat="server"  onserverclick="submit_ServerClick"  visible="true"> Submit</button></form>
                                    <div class="cleaner"></div>
